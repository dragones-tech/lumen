...
const MODULES = [
  ...
  ['http', 'Small fetch wrapper — JSON, HttpError, per-request AbortSignal, retry/backoff, onRequest/onResponse interceptors.'],
  ['resource', 'Observable server state — stale-while-revalidate cache over a fetcher: dedupe, revalidation, optimistic mutate.'],
